...
#define CAFFE2_GIT_VERSION "v0.8.1-1408-g464ca44-dirty"
...
#define CAFFE2_BUILD_STRINGS { \
  {"GIT_VERSION", "v0.8.1-1408-g464ca44-dirty"}, \
  {"CXX_FLAGS", " -DONNX_NAMESPACE=onnx_c2 -O2 -fPIC -Wno-narrowing -Wno-invalid-partial-specialization"}, \
  {"BUILD_TYPE", "Release"}, \
  {"BLAS", "Eigen"}, \
  {"USE_ATEN", "OFF"}, \
  {"USE_CUDA", "OFF"}, \
