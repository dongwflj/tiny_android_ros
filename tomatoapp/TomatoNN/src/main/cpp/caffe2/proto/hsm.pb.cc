...
void InitDefaultsNodeProto() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsNodeProtoImpl);
}
...
void InitDefaultsTreeProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_caffe2_2fproto_2fhsm_2eproto::InitDefaultsNodeProto();
  {
...
void InitDefaultsTreeProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTreeProtoImpl);
}
...
void InitDefaultsHierarchyProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_caffe2_2fproto_2fhsm_2eproto::InitDefaultsPathProto();
  {
...
void InitDefaultsHierarchyProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsHierarchyProtoImpl);
}
...
void InitDefaultsPathProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_caffe2_2fproto_2fhsm_2eproto::InitDefaultsPathNodeProto();
  {
...
void InitDefaultsPathProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsPathProtoImpl);
}
...
void InitDefaultsPathNodeProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsPathNodeProtoImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "caffe2/proto/hsm.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
TreeProto::TreeProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_caffe2_2fproto_2fhsm_2eproto::InitDefaultsTreeProto();
  }
  SharedCtor();
...
::google::protobuf::uint8* TreeProto::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *this->root_node_, deterministic, target);
  }
...
HierarchyProto::HierarchyProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_caffe2_2fproto_2fhsm_2eproto::InitDefaultsHierarchyProto();
  }
  SharedCtor();
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(18u /* 18 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_path_nodes()));
        } else {
          goto handle_unusual;
        }
        break;
...
void PathProto::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->path_nodes(static_cast<int>(i)), output);
  }
...
void PathProto::InternalSwap(PathProto* other) {
  using std::swap;
  path_nodes_.InternalSwap(&other->path_nodes_);
